...
def my_main(my_list, station_names):
    ...
    my_list = my_map(lambda y : (y[1], y[5]), my_list) # -> Replace None with a call to my_map
    ...
    my_list = my_filter(lambda y : y[1] == 0, my_list) # -> Replace None with a call to my_filter
    ...
    my_list = my_filter(lambda y : y[0] in station_names, my_list) # -> Replace None with a call to my_filter
    ...
    my_list = my_map(lambda y : [y[0],1], my_list) # -> Replace None with a call to my_map
    ...
    res = my_fold(lambda x, y : y[1] == 1, 0, my_list) # -> Replace None with a call to my_fold
...
if __name__ == '__main__':
    ...
    output_file_name = "../../my_result/A01 - Hint4/result.txt"
