...
def my_reduce(my_input_stream, my_output_stream, my_reducer_input_parameters):
    ...
    for line in my_input_stream:
        ...
        total += keyVal[1]
    my_str = "Fitzgerald's Park" + "\t" + "(" + str(total) + ")" + "\n"
...
if __name__ == '__main__':
    ...
    # 2. Debug Names
    input_file_example = "../../../my_result/A01 - Hint2/FirstRound/my_sort_results.txt"
    output_file_example = "../../my_result/A01 - Hint2/FirstRound/my_reducer_results.txt"
